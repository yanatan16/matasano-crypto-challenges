...
public final class SHA1 {
    ...
    */
    public static String hash (String plain) {
        return sha1(pad(plain));
    }
    public static String hash(String plain, int[] H) {
        return sha1(pad(plain), H);
    }
    public static String pad ( String plain) {
    ...
    private static String sha1(int[] Message) {
         int H1 = SHA1.h1;
         int H2 = SHA1.h2;
         int H3 = SHA1.h3;
         int H4 = SHA1.h4;
    ...
    private static String sha1(int[] Message, int[] H) {{
         int H1 = H[0];
         int H2 = H[1];
         int H3 = H[2];
         int H4 = H[3];
